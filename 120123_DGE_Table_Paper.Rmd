...
# write.csv(B2Mother20_vsA2C2virgin, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_logflold_0/B2Mother20_vsA2C2virgin.csv")
...
# 
# write.csv(B2mother20_D2mother30, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_mother20vsmother30_logfold0_csv/B2mother20_D2mother30.csv")
```
...
# write.csv(B2_A2C2deep, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_A2C2deep.csv")
```
...
# write.csv(B2_A2C2superficial, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_A2C2superficial.csv")
```
...
# write.csv(B2_A2C2ELP, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_A2C2ELP.csv")
```
...
# write.csv(B2_A2C2GL, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_A2C2GL.csv")
```
...
# write.csv(B2_A2C2MCL, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_A2C2MCL.csv")
...
# write.csv(B2_A2C2RMS, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_A2C2RMS.csv")
...
# write.csv(B2_A2C2AOB, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_A2C2AOB.csv")
```
...
# write.csv(B2_A2C2deep, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/D2_A2C2deep.csv")
...
# write.csv(D2_A2C2superficial, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/D2_A2C2superficial.csv")
...
# write.csv(D2_A2C2EPL, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/D2_A2C2EPL.csv")
```
...
# write.csv(D2_A2C2GL, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/D2_A2C2GL.csv")
...
# write.csv(D2_A2C2MCL, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/D2_A2C2MCL.csv")
...
# write.csv(D2_A2C2AOB, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/D2_A2C2AOB.csv")
...
# write.csv(cluster4, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/cluster4.csv")
```
...
# write.csv(B2_cluster4, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_cluster4.csv")
```
...
# write.csv(cluster9, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/cluster9.csv")
```
...
# write.csv(B2_cluster9, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_cluster9.csv")
```
...
# write.csv(B2_cluster9_logfold0, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/B2_cluster9_logfold0.csv")
```
...
# write.csv(D2_cluster4, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/D2_cluster4.csv")
```
...
# write.csv(D2_cluster9, "/media/Jonas_Kretz/Visium_gene_expression/Visium_mouse_brain/Analysis_mouse_brain/Workflow_sct_merge_log/Rmd_and_data/processed_data/DGE_csv/D2_cluster9.csv")
```
